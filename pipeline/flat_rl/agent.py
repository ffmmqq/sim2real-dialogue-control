...
class FlatActorCriticAgent:
    ...
    def select_action(
        ...
        tempered_logits = masked_logits / self.sampling_temperature
        ...
        return {
            ...
            "flat_action_name": f"{option_name}/{subaction_name}",
            "sampling_temperature": self.sampling_temperature,
            "selected_action_probability": probs[action_idx].item(),
            "state_value": state_value,
            "action_logits": logits.detach().cpu().tolist(),
            "action_probabilities": probs.detach().cpu().tolist(),
        }
