...
from pipeline.utils.dialoguebert_model import DialogueBERTModel
...
class DialogueBERTIntentRecognizer:
    ...
    def __init__(self, model_name: Optional[str] = None,
        ...
        """
        model_name = model_name or os.environ.get("HRL_BERT_MODEL", "bert-base-uncased")
        self.model_name = model_name
        self.device = (
            device
            or os.environ.get("HRL_BERT_DEVICE")
    ...
    def _load_fallback_model(self):
        ...
        try:
            fallback_name = os.environ.get("HRL_BERT_MODEL", "bert-base-uncased")
